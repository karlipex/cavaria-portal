...
class Contacto extends CI_Model {
 ...
 public function getContacto($id)
 {
   ...
   $query=$this->db->select("c.idcontacto,c.nombre,c.email,c.telefono,c.tratamiento,t.descripcion,c.descuento,DATE_FORMAT(c.fechaIngreso,'%d/%m/%Y')as fechaIngreso,c.origen,c.campana",false)
   ->from("contacto c")
   ->join("tratamiento t","c.tratamiento= t.idtratamiento")
   ->where($where)
   ->get();
